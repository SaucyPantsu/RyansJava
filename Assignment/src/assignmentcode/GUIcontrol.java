...
public class GUIcontrol extends JFrame implements ActionListener, MouseListener{
	...
	public void GUI() {
		//defining frame
		Frame = new JFrame("Naive Bayes Classifier")	;
		...
		//defining buttons
		Button = new JButton("Train Naive Bayes");
		Button2 = new JButton("Test your own information");
		Button3 = new JButton("View current statistics");
		Button4 = new JButton("Input dataset location");
